...
import com.Twotwo.TwotwoTV.data.ReleaseResponse
...
class UpdateManager(
        ...
        CoroutineScope(Dispatchers.Main).launch {
            ...
            try {
                ...
                val fileName = if (release.apk_name?.contains(release.version_name!!) == true) {
                    ...
                    "twotwotv_v${release.version_name}.apk"
                }
    ...
    companion object {
        ...
        private const val VERSION_URL =
            "https://raw.githubusercontent.com/horsemail/twotwotv/main/version.json"
    }
}
