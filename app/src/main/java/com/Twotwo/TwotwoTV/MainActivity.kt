...
import com.Twotwo.TwotwoTV.databinding.SettingsWebBinding
...
import com.Twotwo.TwotwoTV.Utils.ViewModelUtils
...
class MainActivity : AppCompatActivity() {
    ...
    private var ok = 0
    internal var playerFragment = com.Twotwo.TwotwoTV.PlayerFragment()
    internal val errorFragment = com.Twotwo.TwotwoTV.ErrorFragment()
    internal val loadingFragment = com.Twotwo.TwotwoTV.LoadingFragment()
    internal var infoFragment = com.Twotwo.TwotwoTV.InfoFragment()
    internal var channelFragment = com.Twotwo.TwotwoTV.ChannelFragment()
    internal var timeFragment = com.Twotwo.TwotwoTV.TimeFragment()
    internal var menuFragment = com.Twotwo.TwotwoTV.MenuFragment()
    internal var settingFragment = com.Twotwo.TwotwoTV.SettingFragment()
    internal var programFragment = com.Twotwo.TwotwoTV.ProgramFragment()
    internal var sourceSelectFragment = com.Twotwo.TwotwoTV.SourceSelectFragment()
    ...
    fun handleWebviewTypeSwitch(enable: Boolean) {
        ...
        lifecycleScope.launch(Dispatchers.Main) {
            try {
                ...
                com.Twotwo.TwotwoTV.SP.enableWebviewType = true
