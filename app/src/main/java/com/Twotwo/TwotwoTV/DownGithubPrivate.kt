...
object DownGithubPrivate {
    ...
    private const val WORKER_API_URL = "https://twotwotv.horsenma.top"
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                if (!url.startsWith("http://") && !url.startsWith("https://")) {
                    ...
                    val (repo, branch, filePath) = parseGitHubUrl("https://github.com/horsenmail/twotwotv/raw/main/$url")
                    ...
                    if (isPrivateRepo && token != null && filePath != null && branch != null) {
                        ...
                        val githubUrl = "https://raw.githubusercontent.com/horsenmail/twotwotv/main/$url"
