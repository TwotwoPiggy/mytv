...
class TwotwoTVApplication : Application() {

    companion object {
        private const val TAG = "TwotwoTVApplication"
        private const val KEY_FULL_SCREEN_MODE = "full_screen_mode" // 全屏模式键
        private lateinit var instance: TwotwoTVApplication

        @JvmStatic
        fun getInstance(): TwotwoTVApplication {
            return instance
        }
    }
    ...
    override fun onCreate() {
        ...
        Thread.setDefaultUncaughtExceptionHandler(TwotwoTVExceptionHandler(this))
